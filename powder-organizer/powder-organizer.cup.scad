// Generated by SolidPython 1.1.3 on 2025-08-15 18:11:16
$fn = 64;


scale(v = [1.0300000000, 1.0300000000, 0.9800000000]) {
		...
		difference() {
			union() {
				difference() {
					...
					union() {
						difference() {
							translate(v = [-0.0100000000, 1.5000000000, 0]) {
						...
						translate(v = [19.0000000000, 4, 0]) {
							circle($fn = 16, r = 2.5000000000);
						}
					}
				}
				translate(v = [23.0000000000, 40, 0]) {
					circle(r = 1.5000000000);
				}
				translate(v = [22.25, 37.401923788646684, 0]) {
					square(size = [1.5000000000, 1.5000000000]);
				}
			}
			translate(v = [24.5, 37.401923788646684, 0]) {
				circle(r = 1.5000000000);
			}
		}
	}
