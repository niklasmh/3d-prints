					...
					difference() {
						...
						translate(v = [0, 0, -0.1000000000]) {
							linear_extrude(height = 30.2000000000) {
								polygon(points = [[0, 0], [96.59258262890683, 25.881904510252074], [-96.59258262890683, 25.881904510252102], [0, 0]]);
							}
						}
					}
					union() {
						translate(v = [-7.244443697168012, 1.9411428382689075, 0]) {
							cylinder($fn = 24, h = 30, r = 2.5000000000);
						}
						translate(v = [7.244443697168012, 1.9411428382689075, 0]) {
							cylinder($fn = 24, h = 30, r = 2.5000000000);
						}
